...
//LIVIO #include "api/HardwareI2C.h"
...
class TwoWire : public HardwareI2C
{
  ...
  private:
    ...
    // RX Buffer
// ORIGINALE    arduino::RingBufferN<256> rxBuffer;
    RingBufferN<256> rxBuffer;	// LIVIO

    //TX buffer
// ORIGINALE      arduino::RingBufferN<256> txBuffer;
    RingBufferN<256> txBuffer;	// LIVIO
    uint8_t txAddress;
