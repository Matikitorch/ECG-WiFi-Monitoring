...
{
	chip = 52;
	//Serial.println("w5100.cpp: detect W5200 chip");	// DEBUG
	if (!softReset()) return 0;
	writeMR(0x08);
	...
	//Serial.print("version=");		// DEBUG
	//Serial.println(ver);		// DEBUG
	if (ver != 3) return 0;
	//Serial.println("chip is W5200");	// DEBUG
	return 1;
}
...
{
	chip = 55;
	//Serial.println("w5100.cpp: detect W5500 chip"); // DEBUG
	if (!softReset()) return 0;
	writeMR(0x08);
	if (readMR() != 0x08) return 0;
	writeMR(0x10);
	...
	//Serial.println(ver);					// DEBUG
	if (ver != 4) return 0;
	//Serial.println("chip is W5500");		// DEBUG
	return 1;
}
