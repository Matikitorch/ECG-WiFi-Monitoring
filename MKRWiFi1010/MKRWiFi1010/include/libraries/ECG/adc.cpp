...
#define IRQ_SAMPLE_RATE		(1000000)
...
void TC5_Handler(void)
{
	...
	analogWrite(A0, analogRead(A1));
	
	digitalWrite(A2, toggle);
	toggle ^= 1;
...
void tcConfigure()
{
	...
	TC5->COUNT16.CC[0].reg = (uint16_t) (SystemCoreClock / IRQ_SAMPLE_RATE);
	while (tcIsSyncing());
